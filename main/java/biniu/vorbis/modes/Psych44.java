...
public class Psych44 {
    ...
    static final InfoPsyGlobal[] _psy_global_44 = {
    ...
    static final CompandBlock[] _psy_compand_44 = {
            /* sub-mode Z short */
    ...
    static final VpAdjBlock[] _vp_tonemask_adj_longblock = {
    ...
    static final VpAdjBlock[] _vp_tonemask_adj_otherblock = {
            /* 63     125     250     500       1       2       4       8      16 */
    ...
    static final Noise3[] _psy_noisebias_trans = {
    ...
    static final Noise3[] _psy_noisebias_long = {
            /*63     125     250     500      1k       2k      4k      8k     16k*/
            /* -1 */
    ...
    static final Noise3[] _psy_noisebias_impulse = {
            /*  63     125     250     500      1k      2k      4k      8k     16k*/
            /* -1 */
            new Noise3(Util.intTab(Util.intTab(-10, -10, -10, -10, -10, -4, 0, 0, 4, 8, 8, 8, 8, 10, 12, 14, 20),
                    Util.intTab(-30, -30, -30, -30, -26, -20, -16, -8, -6, -6, -2, 2, 2, 3, 6, 6, 15),
    ...
    static final Noise3[] _psy_noisebias_padding = {
            /*  63     125     250     500      1k       2k      4k      8k     16k*/
    ...
    static final NoiseGuard[] _psy_noiseguards_44 = {
    ...
    static final int[] _psy_tone_suppress = {
            -20, -20, -20, -20, -20, -24, -30, -40, -40, -45, -45, -45,
    };
    static final int[] _psy_tone_0dB = {
            90, 90, 95, 95, 95, 95, 105, 105, 105, 105, 105, 105,
    };
    static final int[] _psy_noise_suppress = {
            -20, -20, -24, -24, -24, -24, -30, -40, -40, -45, -45, -45,
    };

    public static final PsyInfo _psy_info_template = new PsyInfo(
            /* blockflag */
            -1,
    ...
    static final int[] _psy_ath_floater = {
            -100, -100, -100, -100, -100, -100, -105, -105, -105, -105, -110, -120,
    };
    static final int[] _psy_ath_abs = {
    ...
    static final AdjStereo[] _psy_stereo_modes_44 = {
    ...
    static final Att3[] _psy_tone_masteratt_44 = {
    ...
    /** lowpass by mode */
    static final double[] _psy_lowpass_44 = {
